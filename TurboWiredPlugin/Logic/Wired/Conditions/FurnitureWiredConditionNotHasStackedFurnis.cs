...
{
    public class FurnitureWiredConditionNotHasStackedFurnis : FurnitureWiredConditionLogic
    {
        ...
        public override int WiredKey => (int)FurnitureWiredConditionType.NotHasStackedFurnis;
    }
}